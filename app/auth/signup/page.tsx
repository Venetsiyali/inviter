            ...
            >
                ...
                >
                    ...
                    <a
                        ...
                        className="flex items-center justify-center gap-3 w-full px-6 py-3 border-2 border-gray-200 rounded-xl font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
                    >
